      ...
      <section className={styles.navMobContainer}>
        <div
          className={`navIcon-container ${
            isActive("/homePage") ? "rounded-3xl bg-azul-principal" : "brightness-50"
          }`}
        >
          <Link href="/homePage">
      ...
      <section className={styles.navDesk}>
        <div className={styles.imgResist}>
          ...
          <div className={styles.navIconMid}>
            <div
              className={isActive("/") ? styles.navIconSelected : styles.navIcon}  
            >
              <Link href="/">
              <HomeIcon  className={isActive("/") ? styles.iconSelect : styles.icon}/>
