    ...
    return (
      <View style={styles.generalcontainer}>
          ...
          <View style={styles.container}>
            <CustomText title={user.permissoes===0 ? "Minhas sugestões" : "Minhas sugestões"} style={styles.subtitle}/>
            <SuggestionList userId={userId} userLevel={Number(user?.permissoes ?? 0)} navigation={navigation} />
            <FabButton 
                userId={userId} 
                icon="camera" 
                position="top" 
