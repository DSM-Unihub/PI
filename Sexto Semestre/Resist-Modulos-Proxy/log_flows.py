...
# Lista de bloqueio total (manual / API) → bloqueados_total.txt
try:
    with open("/root/bloqueados_total.txt", "r", encoding="utf-8") as f:
        blacklist = [line.strip().lower() for line in f if line.strip()]
except FileNotFoundError:
    blacklist = []
    print("Arquivo bloqueados_total.txt não encontrado. Continuando sem blacklist.")
